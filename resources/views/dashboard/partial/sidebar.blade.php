<aside class="dashboard-sidebar">
    ...
    <nav class="sidebar-nav">
        <!-- Overview -->
        <div class="sidebar-nav-item active" title="Overview">
        ...
        <!-- Agents -->
        <div class="sidebar-nav-item" title="Agents">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
            ...
            <div class="sidebar-tooltip">Agents</div>
        </div>

        <!-- Messages -->
        <div class="sidebar-nav-item" title="Messages">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
            ...
            <div class="sidebar-tooltip">Messages</div>
        </div>

        <!-- Events -->
        <div class="sidebar-nav-item" title="Events">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
        ...
        <!-- Training Data -->
        <div class="sidebar-nav-item" title="Training">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
            ...
            <div class="sidebar-tooltip">Training</div>
        </div>

        <!-- Billing -->
        <div class="sidebar-nav-item" title="Billing">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
    ...
    <div class="sidebar-footer">
        <div class="sidebar-nav-item" title="Settings">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
