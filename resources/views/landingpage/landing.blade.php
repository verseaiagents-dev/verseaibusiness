...
<head>
    @include('landingpage.partials.headcontent', [
        'title' => 'VersAI - İşletmenize Özel Yapay Zeka Agent Platformu',
        'description' => 'VersAI, işletmeler için özelleştirilebilir yapay zeka agentları sunar. E-ticaret, turizm ve emlak sektörlerinde müşteri etkileşimini artırın, web sitenize embed.js ile kolayca entegre edin.',
        'keywords' => 'VersAI, AI Agent, Yapay Zeka Chatbot, E-ticaret AI, Turizm AI, Emlak AI, Embed.js, Chrome Extension, AI İşletme Çözümleri'
    ])
    <meta name="language" content="{{ app()->getLocale() }}">
    <meta name="available-languages" content="en,tr,ar,fr">
</head>
            ...
            <div class="container">
                ...
                <a class="logo" href="{{ route('home') }}">
                    <!-- <div class="block sm:hidden">
                        <img src="{{ asset('landingpage/images/logo-icon-40.png') }}" class="h-10 inline-block dark:hidden"  alt="">
                        <img src="{{ asset('landingpage/images/logo-icon-40-white.png') }}" class="h-10 hidden dark:inline-block"  alt="">
                    </div> -->
                ...
                <div class="grid grid-cols-1 text-center">
                    <div class="">
                         <h4 class="font-bold lg:leading-normal leading-normal text-4xl lg:text-6xl mb-5">
                              ...
                              <span class="typewrite bg-gradient-to-br from-amber-400 to-fuchsia-600 text-transparent bg-clip-text" data-period="2000" data-type='[ "{{ __('landing.feature_1_title') }}", "{{ __('landing.feature_2_title') }}", "{{ __('landing.feature_3_title') }}" ]'> 
                          ...
                          <div class="mt-6">
                              <a href="" class="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-amber-400 hover:bg-amber-500 border-amber-400 hover:border-amber-500 text-white rounded-md">{{ __('landing.hero_cta') }}</a>
                              <p class="text-slate-400 dark:text-white/60 text-sm mt-3">{{ __('landing.pricing_free') }} {{ __('landing.hero_learn_more') }}</p>
                          </div>
                          
                    </div>
                    <div class="relative mt-8 z-3">
                        <img src="{{ asset('landingpage/images/classic01.png') }}" alt="" class="mover">
                    </div>
                </div><!--end grid-->
            </div>
            ...
            <div class="container relative">
                <div class="grid md:grid-cols-6 grid-cols-2 justify-center gap-6">
                    <div class="mx-auto py-4">
                        <img src="{{ asset('landingpage/images/client/amazon.svg') }}" class="h-8 md:h-12" alt="Amazon" style="min-height: 24px;">
                    </div>

                    <div class="mx-auto py-4">
                        <img src="{{ asset('landingpage/images/client/google.svg') }}" class="h-8 md:h-12" alt="Google" style="min-height: 24px;">
                    </div>
                    
                    <div class="mx-auto py-4">
                        <img src="{{ asset('landingpage/images/client/lenovo.svg') }}" class="h-8 md:h-12" alt="Lenovo" style="min-height: 24px;">
                    </div>
                    
                    <div class="mx-auto py-4">
                        <img src="{{ asset('landingpage/images/client/paypal.svg') }}" class="h-8 md:h-12" alt="PayPal" style="min-height: 24px;">
                    </div>
                    
                    <div class="mx-auto py-4">
                        <img src="{{ asset('landingpage/images/client/shopify.svg') }}" class="h-8 md:h-12" alt="Shopify" style="min-height: 24px;">
                    </div>
                    
                    <div class="mx-auto py-4">
                        <img src="{{ asset('landingpage/images/client/spotify.svg') }}" class="h-8 md:h-12" alt="Spotify" style="min-height: 24px;">
                    </div>
                </div><!--end grid-->
            </div><!--end container-->
        </section><!--end section-->
                ...
                <div class="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 mt-6 gap-6">
                    <div class="relative overflow-hidden bg-white dark:bg-slate-900 rounded-md shadow dark:shadow-gray-800">
                        <div class="p-6 pb-0 relative overflow-hidden after:content-[''] after:absolute after:inset-0 after:mx-auto after:w-72 after:h-72 after:bg-gradient-to-tl after:to-amber-400 after:from-fuchsia-600 after:blur-[80px] after:rounded-full">
                            <img src="{{ asset('landingpage/images/features/video-1.png') }}" class="relative rounded-t-md shadow-md dark:shadow-slate-700 z-1" alt="">
                        </div>
...
<p class="text-slate-400 mt-3">
    VersAI kullanan işletmeler, chatbot destekli otomasyon sayesinde ortalama %35 daha fazla müşteri dönüşümü elde ediyor.
                    ...
                    <div class="relative overflow-hidden bg-white dark:bg-slate-900 rounded-md shadow dark:shadow-gray-800">
                        <div class="p-6 pb-0 relative overflow-hidden after:content-[''] after:absolute after:inset-0 after:mx-auto after:w-72 after:h-72 after:bg-gradient-to-tl after:to-amber-400 after:from-fuchsia-600 after:blur-[80px] after:rounded-full">
                            <img src="{{ asset('landingpage/images/features/video-2.png') }}" class="relative rounded-t-md shadow-md dark:shadow-slate-700 z-1" alt="">
                        </div>
...
<p class="text-slate-400 mt-3">
    Web sitenizde AI destekli canlı sohbet ile ziyaretçilerinizi anında karşılayın ve etkileşimi artırın.
                    ...
                    <div class="relative overflow-hidden bg-white dark:bg-slate-900 rounded-md shadow dark:shadow-gray-800">
                        <div class="p-6 pb-0 relative overflow-hidden after:content-[''] after:absolute after:inset-0 after:mx-auto after:w-72 after:h-72 after:bg-gradient-to-tl after:to-amber-400 after:from-fuchsia-600 after:blur-[80px] after:rounded-full">
                            <img src="{{ asset('landingpage/images/features/video-3.png') }}" class="relative rounded-t-md shadow-md dark:shadow-slate-700 z-1" alt="">
                        </div>
            ...
            <div class="container relative md:mt-24 mt-16">
                <div class="grid md:grid-cols-2 grid-cols-1 items-center gap-6">
                            ...
                            <img src="{{ asset('landingpage/images/features/1.png') }}" class="ltr:rounded-tl-lg rtl:rounded-tr-lg" alt="">
                        </div>
                ...
                <div class="grid md:grid-cols-2 grid-cols-1 items-center gap-6">
                    <div class="relative order-1 md:order-2">
                        <div class="relative overflow-hidden rounded-lg border border-amber-400/5 bg-gradient-to-tl to-amber-400/30  from-fuchsia-600/30 dark:to-amber-400/50 dark:from-fuchsia-600/50 pe-6 pt-6 lg:ms-8">
                            <img src="{{ asset('landingpage/images/features/2.png') }}" class="ltr:rounded-tr-lg rtl:rounded-tl-lg" alt="">
                        </div>
                    </div>
            ...
            <div class="container relative md:mt-24 mt-16">
                <div class="grid md:grid-cols-2 grid-cols-1 items-center gap-6">
                    <div class="relative overflow-hidden after:content-[''] after:absolute after:inset-0 after:mx-auto after:w-72 after:h-72 after:bg-gradient-to-tl after:to-amber-400 after:from-fuchsia-600 after:blur-[80px] after:rounded-full p-6 bg-white dark:bg-slate-900 rounded-md shadow dark:shadow-slate-800">
                        <div class="relative overflow-hidden rounded-lg shadow-md dark:shadow-gray-800 z-1">
                            <div class="relative">
                                <video controls autoplay loop>
                                    <source src="{{ asset('landingpage/images/modern.mp4') }}" type="video/mp4">
                                </video>
                                <a href="" class="absolute top-2 start-2 rounded-full p-0.5 bg-white dark:bg-slate-900 shadow dark:shadow-slate-800 z-10"><img src="{{ asset('landingpage/images/flags/germany.png') }}" class="h-7 w-7 rounded-full" alt=""></a>
                            </div>
                        ...
                        <div class="mt-6">
                            <a href="" class="py-[6px] px-2 inline-flex items-center tracking-wider align-middle duration-500 text-sm text-center rounded bg-amber-400/5 hover:bg-amber-400 border border-amber-400/10 hover:border-amber-400 text-amber-400 hover:text-white font-semibold m-0.5"><img src="{{ asset('landingpage/images/flags/italy.png') }}" class="h-5 w-5 me-1" alt=""> Italian</a>
                            <a href="" class="py-[6px] px-2 inline-flex items-center tracking-wider align-middle duration-500 text-sm text-center rounded bg-amber-400/5 hover:bg-amber-400 border border-amber-400/10 hover:border-amber-400 text-amber-400 hover:text-white font-semibold m-0.5"><img src="{{ asset('landingpage/images/flags/india.png') }}" class="h-5 w-5 me-1" alt=""> Hindi</a>
                            <a href="" class="py-[6px] px-2 inline-flex items-center tracking-wider align-middle duration-500 text-sm text-center rounded bg-amber-400/5 hover:bg-amber-400 border border-amber-400/10 hover:border-amber-400 text-amber-400 hover:text-white font-semibold m-0.5"><img src="{{ asset('landingpage/images/flags/russia.png') }}" class="h-5 w-5 me-1" alt=""> Russian</a>
                            <a href="" class="py-[6px] px-2 inline-flex items-center tracking-wider align-middle duration-500 text-sm text-center rounded bg-amber-400/5 hover:bg-amber-400 border border-amber-400/10 hover:border-amber-400 text-amber-400 hover:text-white font-semibold m-0.5"><img src="{{ asset('landingpage/images/flags/spain.png') }}" class="h-5 w-5 me-1" alt=""> Spanish</a>
                            <a href="" class="py-[6px] px-2 inline-flex items-center tracking-wider align-middle duration-500 text-sm text-center rounded bg-amber-400/5 hover:bg-amber-400 border border-amber-400/10 hover:border-amber-400 text-amber-400 hover:text-white font-semibold m-0.5"><img src="{{ asset('landingpage/images/flags/usa.png') }}" class="h-5 w-5 me-1" alt=""> English</a>
                        </div>
                    </div>
            ...
            <div class="container relative md:mt-24 mt-16">
                ...
                <div class="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 mt-6 gap-6">
                    <div class="relative bg-white dark:bg-slate-900 p-4 rounded-md shadow dark:shadow-gray-700">
                        <img src="{{ asset('landingpage/images/blog/1.jpg') }}" class="rounded-md shadow dark:shadow-gray-700" alt="">
                        <div class="pt-4">
                            ...
                            <div class="mt-5">
                                <a href="#" class="text-lg font-semibold hover:text-amber-400">What is Artificial Intelligence and How Does AI Work For Human</a>
                            </div>

                            <div class="mt-5 flex justify-between items-center">
                                <span class="flex items-center">
                                    <img src="{{ asset('landingpage/images/client/01.jpg') }}" class="h-7 w-7 rounded-full" alt="">
                    ...
                    <div class="relative bg-white dark:bg-slate-900 p-4 rounded-md shadow dark:shadow-gray-700">
                        <img src="{{ asset('landingpage/images/blog/2.jpg') }}" class="rounded-md shadow dark:shadow-gray-700" alt="">
                        <div class="pt-4">
                            <div class="flex justify-between items-center">
                                <div class="space-x-1">
                                    <a href="" class="bg-amber-400/10 text-amber-500 dark:text-amber-400 text-[12px] font-semibold px-2.5 py-0.5 rounded h-5">AI</a>
                            ...
                            <div class="mt-5">
                                <a href="#" class="text-lg font-semibold hover:text-amber-400">Lignin and the future circular make sssay form AI support system</a>
                            </div>
                    ...
                    <div class="relative bg-white dark:bg-slate-900 p-4 rounded-md shadow dark:shadow-gray-700">
                        <img src="{{ asset('landingpage/images/blog/3.jpg') }}" class="rounded-md shadow dark:shadow-gray-700" alt="">
                        <div class="pt-4">
                            <div class="flex justify-between items-center">
                                <div class="space-x-1">
                                    <a href="" class="bg-amber-400/10 text-amber-500 dark:text-amber-400 text-[12px] font-semibold px-2.5 py-0.5 rounded h-5">AI</a>
                            ...
                            <div class="mt-5">
                                <a href="#" class="text-lg font-semibold hover:text-amber-400">Research Operations vs Research Is Always Essay On MasAI Theme</a>
                            </div>
                        ...
                        <div class="grid md:grid-cols-2 items-center">
                            <div class="md:text-start text-center">
                                <a href="#" class="text-[22px] focus:outline-none">
                                    <img src="{{ asset('landingpage/images/logo-light.png') }}" class="mx-auto md:me-auto md:ms-0" alt="">
                                </a>
                            </div>
        ...
        <!-- JAVASCRIPTS -->
        <script src="{{ asset('landingpage/libs/tobii/js/tobii.min.js') }}"></script>
